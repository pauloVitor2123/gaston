...
- category_name: só para gastos (recebimentos não usam categoria). Escolha a categoria mais provável da lista quando der pra inferir com segurança; se não der, deixe em branco (o usuário será perguntado com a lista de categorias).
